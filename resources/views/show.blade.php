                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <a href="/storage/{{$professeur->Dossier_scientifique}}" class="link-success text-danger" download>Appuyer pour télécharger le dossier</a>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <a href="/storage/{{$professeur->Dossier_Pedagogique}}" class="link-success text-danger" download>Appuyer pour télécharger le dossier</a>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <a href="/storage/{{$professeur->Dossier_administratif}}" class="link-success text-danger" download>Appuyer pour télécharger le dossier</a>
                            </div>
                        </div>
